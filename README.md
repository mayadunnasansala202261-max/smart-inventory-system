...
![GitHub repo size](https://img.shields.io/github/repo-size/yourusername/smart-inventory-system)
![GitHub stars](https://img.shields.io/github/stars/yourusername/smart-inventory-system?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/yourusername/smart-inventory-system?style=social)
...
| ------------- | ------------------------------------------------------------------------------------- |
| ![s1](s1.PNG) | **Login Page** – User authentication with dark/light mode                             |
| ![s2](s2.PNG) | **Dashboard (Light Mode)** – Overview of products, suppliers, sales, and stock alerts |
| ![s3](s3.PNG) | **Dashboard (Dark Mode)** – Same dashboard with dark theme                            |
| ![s4](s4.PNG) | **Products Page** – Manage products with search, filter, and CRUD                     |
| ![s5](s5.PNG) | **Suppliers Page** – Manage suppliers and assign to products                          |
